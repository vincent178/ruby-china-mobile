...
object TopicsController extends Controller {
  ...
  def index = Action {
    ...
    val topics = Seq(
      Topic("[广州][2015年10月28日 19:00] GZRUBY 第 27 次聚会 [Post RubyConf 专场]", "allenfantasy", "线下活动", new DateTime("2004-12-13T21:39:45.618-08:00")),
      Topic("欢迎 3 位新的 Ruby China 社区管理员", " huacnlee", "公告", new DateTime("2004-12-13T21:39:45.618-08:00")),
